...
<html lang="en">
<head>
  <title>Eternity Esports | Join WhatsApp Group</title>
  <meta charset="utf-8">
	  ...
	  <div class="row content">
		<div class="col-sm-3 sidenav">
		  ...
		  <ul class="nav nav-pills nav-stacked">
			...
			<li class="active"><a href="">2. Join WhatsApp Group</a></li>
		...
		<div class="col-sm-9">
		  ...
		  <ol>
			<li>Choose the WhatsApp Group Link which you participate (According to the event you participated in before)
			<li><font color="red">Once you join the WhatsApp Group Link, please chat us YOUR SQUAD NAME, otherwise player will be eliminated</font>
		  </ol>
