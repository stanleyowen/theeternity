<?php
    ...
    if (isset($_COOKIE['JScrim'])) {
    	if ($_COOKIE['JScrim'] == sha1(md5('Joined'))){
			echo '<script>alert("Each User can only participate in a scrim. User can participate in other scrim events after the event was ended. If the event has ended, but you still cannot access here, please Logout and Login Again.");document.location="../dashboard/index.php"</script></script>';
		}else{
...
<html lang="en">
<head>
  <title>Eternity Esports | Participate in a Scrim</title>
  <meta charset="utf-8">
	  ...
	  <div class="row content">
		<div class="col-sm-3 sidenav">
		  ...
		  <ul class="nav nav-pills nav-stacked">
			...
			<li class="active"><a href="">1. Participate in a Scrim</a></li>
		...
		<div class="col-sm-9">
		  <h2>How to Participate in a Scrim</h2>
		  ...
		  <ol>
			<li>Read our Terms and Condition before participate in a scrim
			<li>Choose the Scrim Event you wanted to participate in
			<li>Make sure you check all the field
			<li>You cannot follow more than 1 event simultaneously
			<li>Click 'Participate' Button
			<li>Once you click the button, you will be able to access 'Upload Center', 'Attendance', and 'Download Certificates' features
			<li>You won't be able this tab once you have participate in a scrim till the event end
		  </ol>
		  ...
		  <form action="../../function/participate-in-scrim.php" method="post">
			...
			<label class="container">I agree to the <a href="../event/terms-and-conditions-scrim.php">Term and Conditions</a> of the Scrim Rules
			  <input type="checkbox" name="term1">
			  <span class="checkmark"></span>
			</label>

			<label class="container">I agree that The Eternity Esports can collect my Personal Information
