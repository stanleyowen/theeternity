...
<html lang="en">
<head>
  <title>Eternity Esports | Edit Certificate</title>
  <meta charset="utf-8">
		  ...
		  <?php 
			...
			$sql = "SELECT * FROM scrim_token WHERE id='$id'";	
		  	...
		  	while($d = mysqli_fetch_array($query)){ ?>
		  	  <form action="../../../function/update-certificate-link.php" method="post">
			  	<input type="hidden" name="id" value="<?php echo $id?>">
				<label><b>Event Name &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :</b></label>
				<input type="text" placeholder="Enter Alert's Link" value="<?php echo $d['event_name']?>" name="event" disabled><br>

				<label for="link"><b>Link (max 500) &nbsp; &nbsp; &nbsp; &nbsp; :</b></label>
				<input type="url" placeholder="Enter Alert's Link" value="<?php echo $d['certi_link']?>" name="link"><br>
