	...
	<div class="container-fluid">
	  <div class="row content">
		...
		<div class="col-sm-9">
			...
			<?php
				...
				while ($row = mysqli_fetch_array($query))
				{
					echo "<tr>
							...
							<td>
								<a href=\"../../../function/delete-alert-id.php?id=".$row['id']."\"class=\"btn first\" onClick=\"javascript: return confirm('$message')\">Delete</a>
								<a href=\"edit-alert-id.php?id=".$row['id']."\"class=\"btn first\">Edit</a>
							</td>
						  </tr>";
				}
			?>
		  ...
		  <form action="../../../function/add-alert-info.php" method="post">
			...
			<input type="url" placeholder="Enter Alert's Link" name="link" required><br>
			
			<label for="desc"><b>Description (max 500) :</b></label><br>
			<textarea name="description" maxlength="500"></textarea><br>
			<button class="btn first" type="submit" name="addalert">Add</button></p>
		  </form>
		</div>
	  </div>
	</div>
