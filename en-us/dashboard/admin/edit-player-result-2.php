...
<html lang="en">
<head>
  <title>Eternity Esports | Edit Players Result</title>
  <meta charset="utf-8">
		  ...
		  <?php 
			...
			$sql = "SELECT * FROM scrim_member WHERE username='$username'";
		  	...
		  	while($d = mysqli_fetch_array($query)){ ?>
		  	  <form action="../../../function/update-result-2.php" method="post">
		  	  	<input type="hidden" name="username" value="<?php echo $username?>">
			  	<label for="link"><b>Player Name &nbsp; :</b></label>
				<input type="text" value="<?php echo $username?>" disabled><br>

				<label for="rank"><b>Rank &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :</b></label>
				<input type="number" value="<?php echo $d['rank_2']?>" name="rank" required><br>
				
				<label for="kill"><b>Total Kill &nbsp; &nbsp; &nbsp; &nbsp; :</b></label>
				<input type="number" value="<?php echo $d['kill_2']?>" name="kill" required><br>
