		  ...
		  <?php 
			...
			$sql = "SELECT * FROM scrim_member WHERE username='$username'";
		  	...
		  	while($d = mysqli_fetch_array($query)){ ?>
		  	  <form action="../../../function/update-result.php" method="post">
				...
				<input type="number" value="<?php echo $d['rank_1']?>" name="rank" required><br>
				
				<label for="kill"><b>Total Kill &nbsp; &nbsp; &nbsp; &nbsp; :</b></label>
				<input type="number" value="<?php echo $d['kill_1']?>" name="kill" required><br>
