	  ...
	  <div class="row content">
		...
		<div class="col-sm-9">
		  ...
		  <?php
			...
			$sql 	= "SELECT * FROM scrim_token WHERE id='$id'";
		  	$query 	= mysqli_query($connect,$sql);
		  	while($d = mysqli_fetch_array($query)){ ?>
		  	  <form action="../../../function/update-scrim.php" method="post">
		  	  	<input type="hidden" name="id" value="<?php echo $id?>">
			  	<label for="link"><b>Scrim Name &nbsp; &nbsp; &nbsp; &nbsp; :</b></label>
				<input type="text" value="<?php echo $d['event_name']?>" disabled><br>

				<label for="rank"><b>Scrim ID &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :</b></label>
				<input type="text" value="<?php echo $d['scrim_id']?>" disabled><br>
				
				<label for="Token"><b>Token &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :</b></label>
				<input type="text" value="<?php echo $d['token']?>" name="token" required><br>

				<label for="link"><b>WhatsApp Link &nbsp; :</b></label>
				<input type="url" value="<?php echo $d['wa_link']?>" name="link" required><br>
