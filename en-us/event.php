...
<head>
  ...
  <title>Eternity Esports | Events</title>
...
<body oncontextmenu = "return false">
  <footer class="footer text-faded text-center py-3 fixed-top">
    <div class="container">
	  ...
	  <p class="m-0 large" align="right">Languages <i class="fa fa-globe" aria-hidden="true"></i> : <a href="../en-us/event.php">EN</a> | <a href="../id/event.php">ID</a></p>
    </div>
  </footer>
  <br><br><br><br>
