...
<head>
  ...
  <title>Eternity Esports | Register</title>
...
<body oncontextmenu = "return false">
  <footer class="footer text-faded text-center py-3 fixed-top">
    <div class="container">
	  ...
	  <p class="m-0 large" align="right">Languages <i class="fa fa-globe" aria-hidden="true"></i> : <a href="../../en-us/login/register.php">EN</a> | <a href="../../id/login/register.php">ID</a></p>
    </div>
  </footer>
  <br><br><br><br>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
		  ...
		  <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="">Register
	  ...
	  <div class="intro-text left-0 text-center bg-faded p-2 rounded">
            <div class="cta-inner text-center rounded">
				...
				<form action="register.php" method="post">
				  <p><font color='red'>Create yout Squad Account to Login into Dashboard<br>
				  ...
				  <input name="honeypot" type="text" id="honeypot" style="display: none">
					...
					<input type="password" placeholder="Enter Password" name="_confirmpassword" maxlength="50">
					<br>
					<button type="submit" class="submit" name="reg_user">Register</button>
				  </div>
				</form>
				<br><br>
            </div>
