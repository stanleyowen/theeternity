<?php
	if(isset($_SESSION['username']) && isset($_SESSION['role'])){
		...
		if(mysqli_num_rows($result)>0){
			echo'
			<li class="nav-item px-lg-4"><a class="nav-link text-uppercase text-expanded" href="./dashboard/admin/dashboard-admin.php">Dashboard</a></li>
			<li class="nav-item px-lg-4"><a class="nav-link text-uppercase text-expanded" href="../global-validation/logout.php">Keluar</a></li>';
		}else {
			echo'
			<li class="nav-item px-lg-4"><a class="nav-link text-uppercase text-expanded" href="./login">Masuk</a></li>
			<li class="nav-item px-lg-4"><a class="nav-link text-uppercase text-expanded" href="./login/register.php">Daftar</a></li>';
		}
	}else {
		echo'
			<li class="nav-item px-lg-4"><a class="nav-link text-uppercase text-expanded" href="./login">Masuk</a></li>
