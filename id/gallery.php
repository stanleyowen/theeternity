...
<head>
  ...
  <title>Eternity Esports | Galeri</title>
...
<body oncontextmenu = "return false">
  <footer class="footer text-faded text-center py-3 fixed-top">
    <div class="container">
	  ...
	  <p class="m-0 large" align="right">Bahasa <i class="fa fa-globe" aria-hidden="true"></i> : <a href="../en-us/gallery.php">EN</a> | <a href="../id/gallery.php">ID</a></p>
    </div>
  </footer>
  <br><br><br><br>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="gallery.php">Galeri
