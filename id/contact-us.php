...
<head>
  ...
  <title>Eternity Esports | Hubungi Kami</title>
...
<body oncontextmenu = "return false">
    ...
    <div class="container">
	  ...
	  <p class="m-0 large" align="right">Bahasa <i class="fa fa-globe" aria-hidden="true"></i> : <a href="../en-us/contact-us.php">EN</a> | <a href="../id/contact-us.php">ID</a></p>
    </div>
  </footer>
  <br><br><br><br>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="contact-us.php">Hubungi Kami
        ...
        <div class="col-xl-9 mx-auto">
          <div class="cta-inner text-center rounded">
            <h2 class="section-heading mb-5">
              <span class="section-heading-upper">Obrolan Online Tersedia Pada :</span>
            </h2>
            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
              <li class="list-unstyled-item list-hours-item d-flex">
                Minggu
                <span class="ml-auto">9:00 AM sd 9:00 PM</span>
              </li>
              <li class="list-unstyled-item list-hours-item d-flex">
                Senin
                <span class="ml-auto">9:00 AM sd 9:00 PM</span>
