...
<head>
  ...
  <title>Eternity Esports | Masuk</title>
...
<body oncontextmenu = "return false">
  <footer class="footer text-faded text-center py-3 fixed-top">
    <div class="container">
	  ...
	  <p class="m-0 large" align="right">Bahasa <i class="fa fa-globe" aria-hidden="true"></i> : <a href="../../en-us/login/index.php">EN</a> | <a href="../../id/login/index.php">ID</a></p>
    </div>
  </footer>
  <br><br><br><br>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
		  ...
		  <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="">Masuk
				<span class="sr-only">(current)</span>
			</a>
          </li>
		  <li class="nav-item px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="register.php">Daftar</a>
          </li>
        </ul>
      </div>
    </div>
	  ...
	  <div class="intro-text left-0 text-center bg-faded p-2 rounded">
          <div class="cta-inner text-center rounded">
			<h2 class="section-heading mb-4">
				<span class="section-heading-upper">Masuk</span>
            </h2>
            <form action="index.php" method="post">
      			  <p><font color='red'>Masuk dengan Akun yang Anda daftarkan, bukan Akun Gmail<br>
                ...
                <input name="honeypot" type="text" id="honeypot" style="display: none" />
        				...
        				<label><b>Nama Clan :</b></label>
        				<input type="text" placeholder="Masukkan Nama Clan" name="_username" maxlength="50">
        				
        				<label><b>Kata Sandi :</b></label>
        				<input type="password" placeholder="Masukkan Kata Sandi" name="_password" maxlength="50">
        				
        				<label><b>Peran/Level :</b></label>
        				<select name="validation_role">
        					<option value='user'>Pengguna</option>
        					<option value='admin'>Administrator</option>
        				</select>
        				
        				<button type="submit" class="submit" name="login_user">Masuk</button>
        			  </div>
    			  </form>
            <br><br>
          </div>
